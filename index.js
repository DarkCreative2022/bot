...
client.on('ready', async () => {
  ...
  console.log(`Made by Ano Gaming YTᵈᵉᵛ#5457`)
  console.log(`Credits |  https://dsc.gg/manager.development`)
  console.log(`Join above or you gay`)
  client.user.setActivity(config.status.name, { type: config.status.type.toUpperCase(), url: "https://www.youtube.com/channel/UCuZSjlipjEHGaFztY8UPH2w" })
});
